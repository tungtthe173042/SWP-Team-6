<%-- 
    ...
    Created on : Aug 8, 2024, 4:50:05 PM
    Author     : nitro5
--%>
...
<html>
    <head>
        ...
        <link href="admin/css_admin/sb-admin-2.min.css" rel="stylesheet">
    ...
    <body id="page-top">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <a href="newaccount" class="btn btn-primary">New Account</a>
        ...
        <script src="admin/js_admin/sb-admin-2.min.js"></script>
        ...
        <script src="admin/js_admin/demo/datatables-demo.js"></script>
    </body>
</html>
