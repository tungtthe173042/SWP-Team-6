                            ...
                            <div class="login-form">
                                <form action="login" method="post" id="form">
                                    <div class="form-group">
                                        ...
                                        <input class="au-input au-input--full" name="name" placeholder="Username" value="${username}">
                                    </div>
                                    <div class="form-group">
                                        <label>Password</label>
                                        <input class="au-input au-input--full" type="password" name="pass" placeholder="Password" value="${pass}">
                                    </div>
